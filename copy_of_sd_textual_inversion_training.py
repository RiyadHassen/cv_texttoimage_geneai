# -*- coding: utf-8 -*-
"""Copy of sd_textual_inversion_training.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1I-EZxTufxpsLBiZ9lG1_XkItilK8K9Nj
...
urls = [
      "/content/sample_data/images/00 (2).jpg",
      "/content/sample_data/images/01 (1).jpg",
      "/content/sample_data/images/02 (1).jpg",
      "/content/sample_data/images/04 (1).jpg",
...
name_of_your_concept = "Dog-cv" #@param {type:"string"}
...
hf_token_write = "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" #@param {type:"string"}
...
prompt = "a dog with Eiffel tower in the background" #@param {type:"string"}
...
prompt = "a <dog-cv> with Eiffel tower in the background" #@param {type:"string"}
